...
export function Features() {
  return (
    <section id="features" className="w-full py-16 md:py-20 px-5 md:px-20 bg-[#0a0a0a]">
      <div className="max-w-[1440px] mx-auto flex flex-col items-center gap-10 md:gap-12">
        ...
        <FadeIn className="flex flex-col items-center gap-3 text-center">
          ...
          <h2 className="text-[32px] md:text-[40px] font-bold text-[#f0f0f0] leading-tight max-w-[600px]">
            Everything your team needs to stay in control.
          </h2>
          <p className="text-[15px] md:text-[16px] text-[#888888] max-w-[500px] leading-relaxed">
        ...
        <div className="w-full max-w-[1100px] flex flex-col gap-3">
          ...
          {/* Row 1 */}
          <FadeIn className="flex flex-col md:flex-row gap-3">
            {/* Big card — Real-time */}
            <div className="flex-1 p-7 md:p-8 rounded-xl bg-[#141414] border border-[#2a2a2a] flex flex-col gap-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#363636]">
              <FeatureIcon color="#4d7c6f" bg="rgba(77,124,111,0.13)">
                <path d="M13 10V3L4 14h7v7l9-11h-7z" />
              </FeatureIcon>
              <div className="flex flex-col gap-2">
                <h3 className="text-[20px] md:text-[22px] font-bold text-[#f0f0f0]">
                  Real-time inventory
                </h3>
                <p className="text-[14px] text-[#888888] leading-relaxed max-w-[420px]">
              ...
              <div className="flex gap-8 mt-2">
                <div className="flex flex-col gap-1">
                  <span className="font-mono text-[26px] md:text-[28px] font-bold text-[#4d7c6f] leading-none">~1s</span>
                  <span className="text-[12px] text-[#888888]">Update latency</span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="font-mono text-[26px] md:text-[28px] font-bold text-[#4d7c6f] leading-none">99.9%</span>
                  <span className="text-[12px] text-[#888888]">Uptime SLA</span>
                </div>
              </div>
            </div>

            {/* Small card — Transfers */}
            <div className="w-full md:w-[280px] shrink-0 p-7 rounded-xl bg-[#141414] border border-[#2a2a2a] flex flex-col gap-3 justify-between transition-all duration-200 hover:-translate-y-0.5 hover:border-[#363636]">
          ...
          {/* Row 2 */}
          <FadeIn delay={0.05} className="flex flex-col md:flex-row gap-3">
            {/* QR Loans */}
            <div className="flex-1 p-7 rounded-xl bg-[#141414] border border-[#2a2a2a] flex flex-col gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#363636]">
            ...
            <div className="flex-1 p-7 rounded-xl bg-[#162420] border border-[#4d7c6f44] flex flex-col gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#4d7c6f88]">
            ...
            {/* Smart categories */}
            <div className="w-full md:w-[260px] shrink-0 p-7 rounded-xl bg-[#141414] border border-[#2a2a2a] flex flex-col gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#363636]">
          ...
          {/* Row 3 */}
          <FadeIn delay={0.1} className="flex flex-col md:flex-row gap-3">
            {/* Roles */}
            <div className="flex-1 p-7 rounded-xl bg-[#141414] border border-[#2a2a2a] flex flex-col gap-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#363636]">
              ...
              <p className="text-[13px] text-[#888888] leading-relaxed max-w-[540px]">
